...
export default function LivePage() {
  ...
  // Use backend video feed URL with fallback to placeholder
  const placeholderUrl = 'https://images.unsplash.com/photo-1560807707-8cc77767d783?w=1600&h=900&fit=crop';
  const videoUrl = state.videoFeedUrl || placeholderUrl;

  const handleAction = async (action: string) => {
    // Map button actions to backend prompts
