...
import { Video, Shield, Bell, Server } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const { state, testConnection, updateBackendUrl } = useBackend();
  ...
  const handleTestConnection = async () => {
    ...
    try {
      ...
      if (isConnected) {
        ...
        toast.error(state.connectionError || 'Failed to connect to backend');
      }
    } catch (error) {
      setConnectionStatus('error');
